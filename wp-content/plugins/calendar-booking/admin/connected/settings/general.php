...
<section id="content">
	...
	<div class="block">
		...
		<div class="text-sm">
			...
			<a target="_blank" href="<?php echo CBSB_APP_URL; ?>account/settings?utm_source=plugin&utm_medium=settings&utm_content=adjust-interval"><?php _e('Adjust on Start Booking &rarr;', 'calendar-booking') ?></a>
		</div>
		...
		<div class="text-sm">
			...
			<a target="_blank" href="<?php echo CBSB_APP_URL; ?>account/settingsutm_source=plugin&utm_medium=settings&utm_content=location-type"><?php _e('Adjust on Start Booking &rarr;', 'calendar-booking') ?></a>
		</div>
		...
		<div class="text-sm">
			...
			<a target="_blank" href="<?php echo CBSB_APP_URL; ?>account/settingsutm_source=plugin&utm_medium=settings&utm_content=currency"><?php _e('Adjust on Start Booking &rarr;', 'calendar-booking') ?></a>
		</div>
		...
		<div class="text-sm">
			...
			<a target="_blank" href="<?php echo CBSB_APP_URL; ?>account/settingsutm_source=plugin&utm_medium=settings&utm_content=cancellations"><?php _e('Adjust on Start Booking &rarr;', 'calendar-booking') ?></a>
		</div>
